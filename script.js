...
const i18n = {
  ...
  ru: {
    eyebrow: 'Интерактивный химический атлас',
    title: 'Периодическая площадка',
    lede: 'Нажми на элемент, чтобы увидеть детали. Фильтруй, ищи и исследуй с плавными взаимодействиями.',
    ...
    close: 'Закрыть',
    selectPrompt: 'Выбери элемент, чтобы начать.',
    selectedSuffix: 'выбран.',
    lanthanides: 'Лантаниды',
    actinides: 'Актиниды',
    atomicShort: 'Атомный номер',
    valueUnknown: '—',
    ...
    experimentSlotA: 'Элемент A',
    experimentSlotB: 'Элемент B',
    reactionNo: 'Значимой реакции не наблюдается.',
    reactionIonic: 'Ионная реакция вероятна: перенос электронов.',
    reactionCovalent: 'Ковалентная связь: общее использование электронов.',
    reactionMetallic: 'Металлическая связь: возможен сплав.',
    ...
    timelineNote: 'Элементы, открытые до этого года, подсвечены.',
    ...
    settingsMenus: 'Отключить анимации меню',
    settingsSweep: 'Отключить контурную волну',
    ...
    calcDefault: 'Введите формулу для расчета молярной массы.',
    ...
    reactDefault: 'Введите реагенты для прогноза продуктов.',
    reactErrorEmpty: 'Сначала введите реагенты.',
    reactErrorInvalid: 'Неверная формула или реагент.',
    reactNo: 'Явная реакция не предсказана (растворение или нет реакции).',
    reactDissolve: 'Вероятно растворяется в воде: ионы в растворе.',
    reactWaterMetal: 'Металл + вода: гидроксид металла + водород.',
    reactIonic: 'Ионное соединение вероятно: металл + неметалл.',
    reactCovalent: 'Ковалентное соединение вероятно: неметалл + неметалл.',
    reactInert: 'Инертное поведение: благородные газы редко реагируют.',
    reactProducts: 'Продукты',
    reactNoReaction: 'Реакции нет',
    reactAmphoteric: 'Реакции нет',
    reactProductsUnknown: 'Продукты неясны по текущим правилам.',
    appearance: 'Внешний вид',
    summary: 'Сводка',
    uses: 'Применение',
    summaryTemplate: '{name} — элемент категории {category} с атомным номером {number}. Он находится в периоде {period}, группе {group}. При STP он {phase}.',
    summaryTemplateNoGroup: '{name} — элемент категории {category} с атомным номером {number}. Он находится в периоде {period}. При STP он {phase}.',
    usesTemplate: 'Часто изучается в химии и материаловедении; конкретные применения зависят от области.',
    discoveredBy: 'Открыл',
    namedBy: 'Назвал',
    ...
    chemNoResults: 'Нет химических совпадений.',
    chemHint: 'Введите формулу вроде H2O или NaCl.',
    chemComponents: 'Компоненты',
    chemTopMatch: 'Лучшее совпадение',
    chemTry: 'Введите формулу слева.'
  }
};

const categories = {
  alkali: { label: { en: 'Alkali metal', sq: 'Metal alkalin', de: 'Alkalimetall', fr: 'Metal alcalin', ru: 'Щелочной металл' }, color: '#ff8c61' },
  alkaline: { label: { en: 'Alkaline earth', sq: 'Metal tokesor alkalin', de: 'Erdalkalimetall', fr: 'Metal alcalino-terreux', ru: 'Щёлочноземельный металл' }, color: '#ffd56a' },
  ...
  noble: { label: { en: 'Noble gas', sq: 'Gaz fisnik', de: 'Edelgas', fr: 'Gaz noble', ru: 'Инертный газ' }, color: '#a6ffcb' },
  lanthanide: { label: { en: 'Lanthanide', sq: 'Lantanid', de: 'Lanthanid', fr: 'Lanthanide', ru: 'Лантанид' }, color: '#ffb86b' },
  actinide: { label: { en: 'Actinide', sq: 'Aktinid', de: 'Actinid', fr: 'Actinide', ru: 'Актинид' }, color: '#ff8bd1' }
};
