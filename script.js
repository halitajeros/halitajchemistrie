...
const i18n = {
  ...
  sq: {
    ...
    reactionInert: 'Sjellje inerte: gazrat fisnike rrall� reagojne.',
    radiation: 'Rrezatim',
    ...
    soundOff: 'Zeri: Fikur',
    settings: 'Cil�simet',
    settingsTitle: 'Cil�simet',
    settingsClose: 'Mbyll',
    settingsAnimations: '�aktivizo animacionet',
    settingsEffects: '�aktivizo efektet speciale',
    settingsPulses: '�aktivizo pulsimet',
    settingsMenus: '�aktivizo animacionet e menuseve',
    settingsSweep: '�aktivizo vijen e val�s',
    hint: 'Provo: bateri, inert, gaz fisnik, katalizator',
    calcTitle: 'Llogaritesi i Mas�s Molare',
    calcPlaceholder: 'p.sh. Ca2SO4',
    calcButton: 'Llogarit',
    calcDefault: 'Shkruaj nj� formul� p�r mas�n molare.',
    calcErrorEmpty: 'Shkruaj nj� formul� m� par�.',
    calcErrorInvalid: 'Element i panjohur ose formul� e pavlefshme.',
    reactTitle: 'Llogarit�si i Reaksionit',
  ...
  fr: {
    ...
    title: 'Tableau P�riodique des �l�ments',
    ...
    reactIonic: 'Compos� ionique probable: metal + non-metal.',
    reactCovalent: 'Compos� covalent probable: non-metal + non-metal.',
